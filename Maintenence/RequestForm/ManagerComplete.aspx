<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerComplete.aspx.cs" Inherits="Default2" %>
...
<head runat="server">
    ...
    <title>Maintenance Request Log - Completed</title>
    <style type="text/css">
        .auto-style1 {
            text-align: center;
...
<body>
    ...
    <div>
        <h1 class="auto-style1">Maintenance Request Log - Completed</h1>
    </div>
    <div class ="nav">
    ...
    <div class="auto-style2">
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="Vertical" PageSize="35">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:MaintenanceWorkOrdersConnectionString %>" DeleteCommand="DELETE FROM [User_Data] WHERE [Id] = @original_Id" InsertCommand="INSERT INTO [User_Data] ([Name], [Department], [Building], [Ext], [Urgency], [Problem], [Complete]) VALUES (@Name, @Department, @Building, @Ext, @Urgency, @Problem, @Complete)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [User_Data] WHERE ([Complete] = @Complete)" UpdateCommand="UPDATE [User_Data] SET [Name] = @Name, [Department] = @Department, [Building] = @Building, [Ext] = @Ext, [Urgency] = @Urgency, [Problem] = @Problem, [Complete] = @Complete WHERE [Id] = @original_Id">
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="GridView1" DefaultValue="True" Name="Complete" PropertyName="SelectedValue" Type="Boolean" />
            </SelectParameters>
            <UpdateParameters>
                <asp:Parameter Name="Name" Type="String" />
                <asp:Parameter Name="Department" Type="String" />
